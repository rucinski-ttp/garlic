    ...
    if (req_len < 2) {
        ...
        switch (op) {
            case 0x00: { /* READ_ID */
                ...
                uint16_t id = 0;
                if (grlc_tmp119_read_device_id(addr7, &id)) {
            ...
            case 0x01: { /* READ_TEMP_mC */
                ...
                int32_t mc = 0;
                if (grlc_tmp119_read_temperature_mC(addr7, &mc)) {
                    st = CMD_STATUS_ERR_INTERNAL;
                    break;
                }
            ...
            case 0x02: { /* READ_TEMP_RAW */
                ...
                uint16_t raw = 0;
                if (grlc_tmp119_read_temperature_raw(addr7, &raw)) {
                    st = CMD_STATUS_ERR_INTERNAL;
                    break;
                }
            ...
            case 0x03: { /* READ_CONFIG */
                ...
                uint16_t cfg = 0;
                if (grlc_tmp119_read_config(addr7, &cfg)) {
                    st = CMD_STATUS_ERR_INTERNAL;
                    break;
                }
            ...
            case 0x04: { /* WRITE_CONFIG(u16) */
                ...
                if (grlc_tmp119_write_config(addr7, cfg)) {
                    st = CMD_STATUS_ERR_INTERNAL;
                    break;
                }
                *resp_len = 0;
            ...
            case 0x05: { /* READ_HIGH_LIMIT */
                ...
                uint16_t v = 0;
                if (grlc_tmp119_read_high_limit(addr7, &v)) {
                    st = CMD_STATUS_ERR_INTERNAL;
                    break;
                }
            ...
            case 0x06: { /* WRITE_HIGH_LIMIT(u16) */
                ...
                if (grlc_tmp119_write_high_limit(addr7, v)) {
                    st = CMD_STATUS_ERR_INTERNAL;
                    break;
                }
                *resp_len = 0;
            ...
            case 0x07: { /* READ_LOW_LIMIT */
                ...
                uint16_t v = 0;
                if (grlc_tmp119_read_low_limit(addr7, &v)) {
                    st = CMD_STATUS_ERR_INTERNAL;
                    break;
                }
                resp[0] = (uint8_t)(v & 0xFF);
            ...
            case 0x08: { /* WRITE_LOW_LIMIT(u16) */
                ...
                uint16_t v = (uint16_t)req[2] | ((uint16_t)req[3] << 8);
                if (grlc_tmp119_write_low_limit(addr7, v)) {
                    st = CMD_STATUS_ERR_INTERNAL;
                    break;
                }
                *resp_len = 0;
            ...
            case 0x09: { /* UNLOCK_EEPROM */
                if (grlc_tmp119_unlock_eeprom(addr7)) {
                    st = CMD_STATUS_ERR_INTERNAL;
                    break;
                }
                *resp_len = 0;
            ...
            case 0x0A: { /* READ_EEPROM(idx) */
                ...
                uint8_t idx = req[2];
                uint16_t v = 0;
                if (grlc_tmp119_read_eeprom(addr7, idx, &v)) {
                    st = CMD_STATUS_ERR_INTERNAL;
                    break;
                }
                resp[0] = (uint8_t)(v & 0xFF);
            ...
            case 0x0B: { /* WRITE_EEPROM(idx,u16) */
                ...
                if (grlc_tmp119_write_eeprom(addr7, idx, v)) {
                    st = CMD_STATUS_ERR_INTERNAL;
                    break;
                }
                *resp_len = 0;
            ...
            case 0x0C: { /* READ_OFFSET */
                ...
                uint16_t v = 0;
                if (grlc_tmp119_read_offset(addr7, &v)) {
                    st = CMD_STATUS_ERR_INTERNAL;
                    break;
                }
                resp[0] = (uint8_t)(v & 0xFF);
            ...
            case 0x0D: { /* WRITE_OFFSET(u16) */
                ...
                uint16_t v = (uint16_t)req[2] | ((uint16_t)req[3] << 8);
                if (grlc_tmp119_write_offset(addr7, v)) {
                    st = CMD_STATUS_ERR_INTERNAL;
                    break;
                }
                *resp_len = 0;
...
{
    grlc_cmd_register(CMD_ID_TMP119, handle_tmp119);
}
